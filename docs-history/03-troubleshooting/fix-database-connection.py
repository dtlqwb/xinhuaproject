...
spring:
  datasource:
    ...
    url: ${DB_URL:jdbc:mysql://mysql:3306/sales_customer_db?useUnicode=true&characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai}
...
print("\n6. 后端启动日志")
print("=" * 60)
run("cd /opt/xinhuaproject && docker compose logs --tail=30 backend")
