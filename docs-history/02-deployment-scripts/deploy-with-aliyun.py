...
""")
run(ssh, "sudo systemctl start docker && sudo systemctl enable docker")
...
print("步骤3: 修复Git权限")
print("=" * 60)
run(ssh, "git config --global --add safe.directory /opt/xinhuaproject")
...
# 6. 构建和启动
print("=" * 60)
print("步骤6: 构建Docker镜像（这可能需要5-10分钟）")
print("=" * 60)
